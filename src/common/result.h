...
Q_DECLARE_METATYPE(Skribisto::Result<void>)
Q_DECLARE_METATYPE(Skribisto::Result<int>)
Q_DECLARE_METATYPE(Skribisto::Result<QString>)
Q_DECLARE_METATYPE(Skribisto::Result<QUuid>)
Q_DECLARE_METATYPE(Skribisto::Result<QVariant>)
